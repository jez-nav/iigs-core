...
struct ADBTestVideoSurfaceView: NSViewRepresentable {
    let frame: IIGSVideoFrame
    let isFocused: Bool
    let onFocusChanged: (Bool) -> Void
    let onKeyEvent: (IIGSHostKeyEvent) -> Void

    func makeNSView(context: Context) -> ADBTestVideoSurfaceNSView {
        let view = ADBTestVideoSurfaceNSView()
    ...
    func updateNSView(_ nsView: ADBTestVideoSurfaceNSView, context: Context) {
...
final class ADBTestVideoSurfaceNSView: NSView {
    ...
    override init(frame frameRect: NSRect) {
        ...
        setAccessibilityLabel("Apple IIgs ADB test display")
    }
